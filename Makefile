...
pkgdatadir = $(datadir)/commonwordfinder
pkgincludedir = $(includedir)/commonwordfinder
pkglibdir = $(libdir)/commonwordfinder
pkglibexecdir = $(libexecdir)/commonwordfinder
...
am_commonwordfinder_OBJECTS = commonwordfinder.$(OBJEXT)
commonwordfinder_OBJECTS = $(am_commonwordfinder_OBJECTS)
commonwordfinder_LDADD = $(LDADD)
am_commonwordfinder_mmap_OBJECTS = commonwordfinder_mmap.$(OBJEXT)
commonwordfinder_mmap_OBJECTS = $(am_commonwordfinder_mmap_OBJECTS)
commonwordfinder_mmap_LDADD = $(LDADD)
am_commonwordfinder_vector_OBJECTS =  \
	commonwordfinder_vector.$(OBJEXT)
...
PACKAGE_NAME = commonwordfinder
PACKAGE_STRING = commonwordfinder 0.1
PACKAGE_TARNAME = commonwordfinder
PACKAGE_URL = 
PACKAGE_VERSION = 0.1
PATH_SEPARATOR = :
SET_MAKE = 
...
commonwordfinder$(EXEEXT): $(commonwordfinder_OBJECTS) $(commonwordfinder_DEPENDENCIES) $(EXTRA_commonwordfinder_DEPENDENCIES) 
	@rm -f commonwordfinder$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(commonwordfinder_OBJECTS) $(commonwordfinder_LDADD) $(LIBS)

commonwordfinder_mmap$(EXEEXT): $(commonwordfinder_mmap_OBJECTS) $(commonwordfinder_mmap_DEPENDENCIES) $(EXTRA_commonwordfinder_mmap_DEPENDENCIES) 
	@rm -f commonwordfinder_mmap$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(commonwordfinder_mmap_OBJECTS) $(commonwordfinder_mmap_LDADD) $(LIBS)

commonwordfinder_vector$(EXEEXT): $(commonwordfinder_vector_OBJECTS) $(commonwordfinder_vector_DEPENDENCIES) $(EXTRA_commonwordfinder_vector_DEPENDENCIES) 
